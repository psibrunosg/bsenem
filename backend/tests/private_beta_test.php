...
try {
    ...
    expectSame(8, (int) $pdo->query('SELECT COUNT(*) FROM schema_migrations')->fetchColumn(), 'All migrations run once');
    expectTrue(
    ...
    initializeDatabase();
    expectSame(8, (int) $pdo->query('SELECT COUNT(*) FROM schema_migrations')->fetchColumn(), 'Migrations are idempotent');
